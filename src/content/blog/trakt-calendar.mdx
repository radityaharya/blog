...
excerpt: 'Syncing Trakt to Calendars'
publishDate: '2023-07-16'
tags: ['trakt', 'calendar', 'sync', 'trakt to google calendar', 'trakt to ical', 'trakt to outlook', 'trakt to apple calendar']
seo:
  image:
    src: '/trakt-calendar.png'
    alt: 'Trakt Calendar'
draft: false
---

> [Update!] I started a new project called [Showtime](https://github.com/radityaharya/showtime) a better version of Trakt-ical. Showtime is a web application that allows you to sync your Trakt calendar with your Google Calendar, Apple Calendar, or Outlook Calendar. It's a complete rewrite of Trakt-ical with a better user interface and more features. Check it out on GitHub and give it a try!
...
<img src="/trakt-calendar.png" alt="Trakt Calendar"/>
