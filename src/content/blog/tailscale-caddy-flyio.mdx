...
excerpt: 'A guide to setting up a Tailscale, Caddy, and Fly.io proxy for named domain routing within your tailnet.'
publishDate: '2024-09-15'
tags: ['tailscale', 'caddy', 'fly.io', 'proxy', 'dns', 'tailnet']
seo:
  image:
    src: '/tailscale-caddy-flyio.png'
    alt: 'Tailscale Caddy Fly.io Proxy'
draft: false
---
