...
![Example of the OG image in Light Mode](https://qnhjmybhvmffhqxsggxx.supabase.co/storage/v1/object/public/public/featured-image-automating-og-image-generation.png)
...
![Example of the OG image in Dark Mode](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/bafa869a-1e44-4186-bbfc-bc6d07737783/Untitled.png)

Example of the OG image in Dark Mode

![Example of the OG image in Light Mode](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/7d98f0f0-f35b-435d-9375-83cf76234997/Untitled.png)
